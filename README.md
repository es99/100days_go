...
__31__ - Criando os próprios tipos de variáveis em Go. Introdução a _type conversion_, diferenças entre _Print_, _Sprint_, Fprint_ do pacote _fmt_ e um pouco mais sobre operadores curtos, declaração, inicialização e atraibuição. 
